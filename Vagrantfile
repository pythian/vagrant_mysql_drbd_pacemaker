...
Vagrant::Config.run do |config|
  ...
  config.vm.define :grizzly1 do |grizzly1_config|
    ...
    grizzly1_config.vm.box_url = "https://www.dropbox.com/s/dln3v7nf8nwhf72/package.box?dl=1"
  ...
  config.vm.define :grizzly2 do |grizzly2_config|
    ...
    grizzly2_config.vm.box_url = "https://www.dropbox.com/s/dln3v7nf8nwhf72/package.box?dl=1"
